...
skills: .claude/skills/coo-advisor
domain: c-level
model: sonnet
...
**Skill Location:** `.claude/skills/coo-advisor/`

### Python Tools

1. **Ops Efficiency Analyzer**
   - Path: `.claude/skills/coo-advisor/scripts/ops_efficiency_analyzer.py`
   - Process throughput, cycle time, error rate, automation candidates

2. **OKR Tracker**
   - Path: `.claude/skills/coo-advisor/scripts/okr_tracker.py`
   - Quarter-to-date OKR progress, leading/lagging indicators, on-track / at-risk / off-track

### Knowledge Bases

- `.claude/skills/coo-advisor/references/ops_cadence.md` — weekly/monthly/quarterly rhythm, meeting design
- `.claude/skills/coo-advisor/references/process_frameworks.md` — OKR design, scoring, cascading
- `.claude/skills/coo-advisor/references/scaling_playbook.md` — 1-10, 10-100, 100-1000 transitions

### Adjacent Skills

- `.claude/skills/company-os/` — EOS / Scaling Up / OKR selection
- `.claude/skills/strategic-alignment/` — strategy cascade & silo detection
...
```bash
python .claude/skills/coo-advisor/scripts/okr_tracker.py
```
...
**Steps:**
1. Reference `.claude/skills/company-os/SKILL.md` for selection criteria
...
python .claude/skills/coo-advisor/scripts/okr_tracker.py
python .claude/skills/coo-advisor/scripts/ops_efficiency_analyzer.py
echo "Reference: .claude/skills/coo-advisor/references/ops_cadence.md"
```
...
- Skill: [.claude/skills/coo-advisor/SKILL.md](.claude/skills/coo-advisor/SKILL.md)
