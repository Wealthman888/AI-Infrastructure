...
2. Use `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
/.claude/skills/seo-agent/bin/claude-seo run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
/.claude/skills/seo-agent/bin/claude-seo run render_page.py URL --mode auto --json
...
```bash
/.claude/skills/seo-agent/bin/claude-seo run pagespeed_check.py URL --json
/.claude/skills/seo-agent/bin/claude-seo run crux_history.py URL --json
```
