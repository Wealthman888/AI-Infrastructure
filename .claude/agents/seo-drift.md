...
- `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run drift_baseline.py <url>` -- capture a new baseline
- `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run drift_compare.py <url>` -- compare current state to baseline
- `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run drift_history.py <url>` -- show change history
- `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run drift_report.py <file> --output report.html` -- generate HTML report
