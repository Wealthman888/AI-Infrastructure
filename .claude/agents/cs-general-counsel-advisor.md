...
skills: .claude/skills/general-counsel-advisor
domain: c-level
model: opus
...
**Skill Location:** `.claude/skills/general-counsel-advisor/`

### Python Tools

1. **Contract Risk Scanner**
   - Path: `.claude/skills/general-counsel-advisor/scripts/contract_risk_scanner.py`
   - Usage: `python .claude/skills/general-counsel-advisor/scripts/contract_risk_scanner.py path/to/contract.txt`
...
2. **Term Sheet Analyzer**
   - Path: `.claude/skills/general-counsel-advisor/scripts/term_sheet_analyzer.py`
   - Usage: `python .claude/skills/general-counsel-advisor/scripts/term_sheet_analyzer.py term_sheet.json`
...
- `.claude/skills/general-counsel-advisor/references/contracts_playbook.md` — 7 startup contract types (MSA, SaaS, NDA, DPA, employment, contractor, equity), top redlines per type, quick triage heuristics
- `.claude/skills/general-counsel-advisor/references/ip_and_regulatory.md` — IP inventory (patents, copyright, trademark, trade secrets), invention assignment, OSS license compliance, regulatory trigger matrix (HIPAA, GDPR, FDA, fintech, AI Act), SOC 2 → ISO sequencing
- `.claude/skills/general-counsel-advisor/references/term_sheet_decoder.md` — Full term sheet glossary, founder-friendly defaults cheat sheet, negotiation strategy, the three clauses that matter most
...
python .claude/skills/general-counsel-advisor/scripts/contract_risk_scanner.py path/to/contract.txt
...
python .claude/skills/general-counsel-advisor/scripts/term_sheet_analyzer.py term_sheet.json
...
# 1. Risk scan
python .claude/skills/general-counsel-advisor/scripts/contract_risk_scanner.py "$CONTRACT"

echo ""
echo "📚 Reference checks:"
echo "- Contracts playbook: .claude/skills/general-counsel-advisor/references/contracts_playbook.md"
echo "- Regulatory triggers: .claude/skills/general-counsel-advisor/references/ip_and_regulatory.md"
echo ""
...
- Skill: [.claude/skills/general-counsel-advisor/SKILL.md](.claude/skills/general-counsel-advisor/SKILL.md)
