...
```bash
/.claude/skills/seo-agent/bin/claude-seo run dataforseo_costs.py check <endpoint>
```
...
```bash
/.claude/skills/seo-agent/bin/claude-seo run dataforseo_costs.py log <endpoint> <actual_cost>
```
