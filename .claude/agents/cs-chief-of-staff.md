...
skills: .claude/skills/chief-of-staff
domain: c-level
model: opus
...
**Skill Location:** `.claude/skills/chief-of-staff/`

### Knowledge Bases

- `.claude/skills/chief-of-staff/references/routing-matrix.md` — keywords → role mapping, multi-role triggers
- `.claude/skills/chief-of-staff/references/synthesis-framework.md` — how to combine inputs from multiple advisors

### Coordination Skills

- `.claude/skills/board-meeting/` — 6-phase deliberation protocol with Phase 2 isolation
- `.claude/skills/decision-logger/` — two-layer memory (raw transcripts + approved decisions)
- `.claude/skills/context-engine/` — company-context loading + anonymization
- `.claude/skills/agent-protocol/` — inter-agent invocation, loop prevention, quality loop
...
- Skill: [.claude/skills/chief-of-staff/SKILL.md](.claude/skills/chief-of-staff/SKILL.md)
- Voice spec: [../references/persona-voices.md](../references/persona-voices.md)
- Decision-logger: [.claude/skills/decision-logger/SKILL.md](.claude/skills/decision-logger/SKILL.md)
