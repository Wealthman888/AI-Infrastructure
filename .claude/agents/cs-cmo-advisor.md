...
skills: .claude/skills/cmo-advisor
domain: c-level
model: sonnet
...
**Skill Location:** `.claude/skills/cmo-advisor/`

### Python Tools

1. **Marketing Budget Modeler**
   - Path: `.claude/skills/cmo-advisor/scripts/marketing_budget_modeler.py`
   - Allocates budget across paid/content/events/partnerships with payback by channel

2. **Growth Model Simulator**
   - Path: `.claude/skills/cmo-advisor/scripts/growth_model_simulator.py`
   - Simulates funnel: impressions → leads → opportunities → wins, with assumption sensitivity

### Knowledge Bases

- `.claude/skills/cmo-advisor/references/brand_positioning.md` — category design, message house, narrative arcs
- `.claude/skills/cmo-advisor/references/growth_frameworks.md` — channel-specific motions, PLG vs sales-led
- `.claude/skills/cmo-advisor/references/marketing_org.md` — attribution, cadence, content ops
...
```bash
python .claude/skills/cmo-advisor/scripts/marketing_budget_modeler.py
```
...
python .claude/skills/cmo-advisor/scripts/marketing_budget_modeler.py
python .claude/skills/cmo-advisor/scripts/growth_model_simulator.py
...
- Skill: [.claude/skills/cmo-advisor/SKILL.md](.claude/skills/cmo-advisor/SKILL.md)
