...
skills: .claude/skills/ceo-advisor
domain: c-level
model: opus
...
**Skill Location:** `.claude/skills/ceo-advisor/`
...
1. **Strategy Analyzer**
   ...
   - **Path:** `.claude/skills/ceo-advisor/scripts/strategy_analyzer.py`
   - **Usage:** `python .claude/skills/ceo-advisor/scripts/strategy_analyzer.py`
...
2. **Financial Scenario Analyzer**
   ...
   - **Path:** `.claude/skills/ceo-advisor/scripts/financial_scenario_analyzer.py`
   - **Usage:** `python .claude/skills/ceo-advisor/scripts/financial_scenario_analyzer.py`
...
1. **Executive Decision Framework**
   - **Location:** `.claude/skills/ceo-advisor/references/executive_decision_framework.md`
...
2. **Board Governance & Investor Relations**
   - **Location:** `.claude/skills/ceo-advisor/references/board_governance_investor_relations.md`
...
3. **Leadership & Organizational Culture**
   - **Location:** `.claude/skills/ceo-advisor/references/leadership_organizational_culture.md`
...
1. **Environmental Scan** - Analyze market trends, competitive landscape, regulatory changes
   ```bash
   python .claude/skills/ceo-advisor/scripts/strategy_analyzer.py
   ```
2. **Reference Strategic Frameworks** - Review executive decision-making best practices
   ```bash
   cat .claude/skills/ceo-advisor/references/executive_decision_framework.md
   ```
...
4. **Financial Modeling** - Run scenario analysis for each strategic option
   ```bash
   python .claude/skills/ceo-advisor/scripts/financial_scenario_analyzer.py
   ```
5. **Create Board Package** - Reference governance best practices for presentation
   ```bash
   cat .claude/skills/ceo-advisor/references/board_governance_investor_relations.md
   ```
...
python .claude/skills/ceo-advisor/scripts/financial_scenario_analyzer.py > scenarios.txt
python .claude/skills/ceo-advisor/scripts/strategy_analyzer.py > competitive-position.txt
...
2. **Reference Culture Frameworks** - Study transformation best practices
   ```bash
   cat .claude/skills/ceo-advisor/references/leadership_organizational_culture.md
   ```
...
echo "- Board governance: .claude/skills/ceo-advisor/references/board_governance_investor_relations.md"
echo "- Culture frameworks: .claude/skills/ceo-advisor/references/leadership_organizational_culture.md"
```
...
python .claude/skills/ceo-advisor/scripts/strategy_analyzer.py > strategic-position.txt

# Model financial scenarios
python .claude/skills/ceo-advisor/scripts/financial_scenario_analyzer.py > financial-scenarios.txt
...
- **Skill Documentation:** [.claude/skills/ceo-advisor/SKILL.md](.claude/skills/ceo-advisor/SKILL.md)
