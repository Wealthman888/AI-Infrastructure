...
skills: .claude/skills/cto-advisor
domain: c-level
model: opus
...
**Skill Location:** `.claude/skills/cto-advisor/`
...
1. **Tech Debt Analyzer**
   ...
   - **Path:** `.claude/skills/cto-advisor/scripts/tech_debt_analyzer.py`
   - **Usage:** `python .claude/skills/cto-advisor/scripts/tech_debt_analyzer.py`
...
2. **Team Scaling Calculator**
   ...
   - **Path:** `.claude/skills/cto-advisor/scripts/team_scaling_calculator.py`
   - **Usage:** `python .claude/skills/cto-advisor/scripts/team_scaling_calculator.py`
...
1. **Architecture Decision Records (ADR)**
   - **Location:** `.claude/skills/cto-advisor/references/architecture_decision_records.md`
...
2. **Engineering Metrics**
   - **Location:** `.claude/skills/cto-advisor/references/engineering_metrics.md`
...
3. **Technology Evaluation Framework**
   - **Location:** `.claude/skills/cto-advisor/references/technology_evaluation_framework.md`
...
1. **Run Debt Analysis** - Identify and categorize technical debt across systems
   ```bash
   python .claude/skills/cto-advisor/scripts/tech_debt_analyzer.py
   ```
...
5. **Reference Architecture Frameworks** - Document decisions using ADR template
   ```bash
   cat .claude/skills/cto-advisor/references/architecture_decision_records.md
   ```
...
2. **Run Scaling Calculator** - Model team growth scenarios
   ```bash
   python .claude/skills/cto-advisor/scripts/team_scaling_calculator.py
   ```
...
4. **Reference Engineering Metrics** - Ensure team health indicators support scaling
   ```bash
   cat .claude/skills/cto-advisor/references/engineering_metrics.md
   ```
...
2. **Reference Evaluation Framework** - Use systematic assessment criteria
   ```bash
   cat .claude/skills/cto-advisor/references/technology_evaluation_framework.md
   ```
...
cat .claude/skills/cto-advisor/references/technology_evaluation_framework.md > evaluation-criteria.txt
...
case $DAY_OF_WEEK in
  ...
  Tuesday)
    ...
    cat .claude/skills/cto-advisor/references/architecture_decision_records.md | grep -A 5 "Template"
    ;;
  Friday)
    echo ""
...
python .claude/skills/cto-advisor/scripts/tech_debt_analyzer.py > q$(date +%q)-debt-report.txt
cat q$(date +%q)-debt-report.txt

# Team scaling analysis
echo ""
echo "2. Team Scaling & Organization:"
python .claude/skills/cto-advisor/scripts/team_scaling_calculator.py > q$(date +%q)-team-scaling.txt
...
- **Skill Documentation:** [.claude/skills/cto-advisor/SKILL.md](.claude/skills/cto-advisor/SKILL.md)
