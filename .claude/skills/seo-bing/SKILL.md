...
|---|---|
| `/seo bing links <url>` | `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run bing_webmaster.py compare <urlA> <urlB>`; both properties must be registered to the API account |
| `/seo bing submit <url>` (single URL) | `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run indexnow_submit.py --host ... --urls-file <file>` |
| `/seo bing verify-indexnow` | `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run indexnow_submit.py --host ... --verify-only` |
