...
1. Estimate cost with `$CLAUDE_PROJECT_DIR/.claude/skills/seo-agent/bin/claude-seo run dataforseo_costs.py` (the cost-tracker module is generic and supports Ahrefs unit accounting).
